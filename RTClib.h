...
#define TMR_A_FREQ_CONTROL    0x10
#define TMR_A_REG             0x11
#define PCF8523_OFFSET        0x0E  ///< Offset register
#define PCF8523_MINUTE_ALARM  0x0A  ///< Minute alarm control register
#define PCF8523_HOUR_ALARM    0x0B  ///< Hour alarm control register
#define PCF8523_DAY_ALARM     0x0C  ///< Day alarm control register
#define PCF8523_WEEK_ALARM    0x0D  ///< Weekday alarm control register
#define PCF8523_ALARM_REG_OFF 0x80  ///< Alarm register Off
#define PCF8523_CLKOUT_OFF    0x38
#define PCF8523_ALARM_AIE     0x02   //enable interrupt
...
public:
  ...
  void countDown_Enable(uint8_t timeUnit);
  void setCountDown(uint8_t Time);
  boolean countDownCheck(void);
};
